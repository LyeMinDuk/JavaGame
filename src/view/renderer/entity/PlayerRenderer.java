...
public class PlayerRenderer {
    ...
    private void loadAnimation() {
        ...
        knightAni[ULTIMATE] = new Animation(
                ResourceManager.loadSprite(playerUltimate, KnightFrames.FRAMES.get(ULTIMATE), 64, 64), 7, false);
        knightAni[FROZEN] = new Animation(
                ResourceManager.loadSprite(playerFrozen, KnightFrames.FRAMES.get(FROZEN), 64, 42), 7, false);
        knightAni[SPECIAL] = new Animation(
                ResourceManager.loadSprite(playerSpecial, KnightFrames.FRAMES.get(SPECIAL), 64, 42), 7, false);
        knightSlash = new Animation(
                ResourceManager.loadSprite(ultimateSlash, KnightFrames.FRAMES.get(ULTIMATE), 64, 64), 7, false);
        knightSpecial = new Animation(
                ResourceManager.loadSprite(specialSkill, KnightFrames.FRAMES.get(SPECIAL), 128, 128), 7, false);
        ...
        mageAni[RUN] = new Animation(ResourceManager.loadSprite(mageRun, MageFrames.FRAMES.get(RUN), 128, 128), 15,
                true);
        mageAni[JUMP] = new Animation(ResourceManager.loadSprite(mageJump, MageFrames.FRAMES.get(JUMP), 128, 128), 14,
                false);
